...
from source.cli.graphql.templates import template_crear_tabla_junction
...
class BaseMigrationGenerator(ABC):
    ...
    def _generate_sql_foreign_key(
        self,
        relation: InfoRelacion,
        template_modify_fk: Callable,
    ) -> str:
